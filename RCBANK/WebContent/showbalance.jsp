    ...
    <div class="left">
      ...
      <div class="form">
		...
		int balance = setget.getBalance();
         ...
         %>
        <label for="accountno" class="form-label animation a3 username">Account Username:  <%=  username %></label>
        <label for="accountno" class="form-label animation a3 accountno">Account number:  <%=  accountno %></label>
        <label for="balance" class="form-label animation a4 balance">Account Balance:  <%=  balance %></label>
